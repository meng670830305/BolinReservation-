<template>
  ...
  <el-table :data="tableData.list"
    ...
    <el-table-column prop="name"
                     label="昵称" />
    <el-table-column prop="permissions_id"
                     label="所属组别">
  ...
  <el-dialog v-model="dialogFormVisable"
    ...
    <el-form ref="formRef"
      ...
      <el-form-item label="菜单权限"
                    prop="permissions_id">
        <el-select v-model="form.permissions_id"
                   placeholder="请选择菜单权限"
                   style="width: 240px">
...
const open = (rowData = {}) => {
  ...
  Object.assign(form, { name: rowData.name, mobile: rowData.mobile, permissions_id: rowData.permissions_id })
}
//表单校验
